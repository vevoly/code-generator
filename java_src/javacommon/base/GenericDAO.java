...
public interface GenericDAO<E, PK extends Serializable> {
     ...
     */
    static final String SQLID_INSERT = "insert";
    /**
     * Sqlmap的ID常量，指定插入操作，值为batchInsert
     */
    static final String SQLID_BATCH_INSERT = "batchInsert";
    /**
     * Sqlmap的ID常量，指定更新操作，值为batchUpdate
     */
    static final String SQLID_BATCH_UPDATE = "batchUpdate";
    /**
     * Sqlmap的ID常量，指定更新操作，值为update
     */
    static final String SQLID_UPDATE = "update";
    /**
     * Sqlmap的ID常量，指定删除操作，值为delete
     */
    static final String SQLID_DELETE = "delete";
    /*sqlmap的ID常量，批量删除 batchDelete*/
    static final String SQLID_BATCH_DELETE = "batchDelete";
    /**
     * Sqlmap的ID常量，指定通过id加载一条操作，值为load
     */
    static final String SQLID_LOAD = "load";
    /**
     * Sqlmap的ID常量，指定复杂查询操作返回多条记录，值为query
     */
    static final String SQLID_QUERY = "query";
    /**
     * Sqlmap的ID常量，指定复杂查询操作的统计操作，值为count
     */
    static final String SQLID_COUNT = "count";
    /**
     * 接口常量，用于命名Sqlmap中的排序字段属性名，值为“sortColumn”
     */
    static final String ORDERY_BY_PARAM_NAMES = "sortColumns";
